...
public:
    using DispatchFunction = std::expected<QJsonArray, EvalError>(*)(const detail::PathEvalCtx&, const Token&, const QJsonValue&);
...
private:
    ...
    static constexpr DispatchFunction getDispatchFunction(Token::Kind kind) {
        switch (kind) {
            case Token::Kind::Key: return TokenDispatchTraits<Token::Kind::Key>::dispatch_function;
            case Token::Kind::Index: return TokenDispatchTraits<Token::Kind::Index>::dispatch_function;
            case Token::Kind::Slice: return TokenDispatchTraits<Token::Kind::Slice>::dispatch_function;
            case Token::Kind::Wildcard: return TokenDispatchTraits<Token::Kind::Wildcard>::dispatch_function;
            case Token::Kind::Recursive: return TokenDispatchTraits<Token::Kind::Recursive>::dispatch_function;
            case Token::Kind::Filter: return TokenDispatchTraits<Token::Kind::Filter>::dispatch_function;
            case Token::Kind::KeyList: return TokenDispatchTraits<Token::Kind::KeyList>::dispatch_function;
 ...
 */
template<Token::Kind Kind>
inline std::expected<QJsonArray, EvalError> dispatchTokenKind(
    const detail::PathEvalCtx& ctx, 
    const Token& tk, 
    const QJsonValue& v) noexcept 
{
