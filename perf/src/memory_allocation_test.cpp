...
BenchmarkResult benchmarkWithMemoryTracking(const std::string& jsonPath, const QJsonValue& testData, int iterations = 1000) {
...
int main() {
    ...
    std::cout << "| Test Case | Duration (ns) | Total Allocs (bytes) | Alloc Count | Peak Memory (bytes) | Allocs/Iteration |\n";
    std::cout << "|-----------|---------------|----------------------|-------------|---------------------|------------------|\n";
