...
void analyzeTerminology() {
    ...
    std::cout << "TypeMismatchObject: \"" << json_path::to_string(json_path::EvalError::TypeMismatchObject) << "\"" << std::endl;
    std::cout << "TypeMismatchArray:  \"" << json_path::to_string(json_path::EvalError::TypeMismatchArray) << "\"" << std::endl;
    std::cout << "KeyNotFound:        \"" << json_path::to_string(json_path::EvalError::KeyNotFound) << "\"" << std::endl;
    std::cout << "IndexOutOfRange:    \"" << json_path::to_string(json_path::EvalError::IndexOutOfRange) << "\"" << std::endl;
    std::cout << "InvalidSlice:       \"" << json_path::to_string(json_path::EvalError::InvalidSlice) << "\"" << std::endl;
    ...
    std::cout << "TrailingRecursive:  \"" << json_path::toString(json_path::Error::TrailingRecursive) << "\"" << std::endl;
    ...
    std::cout << "UnmatchedBracket:   \"" << json_path::toString(json_path::Error::UnmatchedBracket) << "\"" << std::endl;
    std::cout << "UnmatchedQuote:     \"" << json_path::toString(json_path::Error::UnmatchedQuote) << "\"" << std::endl;
    std::cout << "UnsupportedFilter:  \"" << json_path::toString(json_path::Error::UnsupportedFilter) << "\"" << std::endl;
    ...
    std::cout << "InvalidIdentifier:  \"" << json_path::toString(json_path::Error::InvalidIdentifier) << "\"" << std::endl;
    std::cout << "UnexpectedAfterRoot:\"" << json_path::toString(json_path::Error::UnexpectedAfterRoot) << "\"" << std::endl;
    ...
    std::cout << "- Index selectors: 'Nothing is selected, and it is not an error, if the index lies outside the range of the array'" << std::endl;
