...
# This toolchain file configures CMake to use LLVM Clang compiler
...
if(NOT LLVM_CLANG_CXX OR NOT LLVM_CLANG_C)
    message(FATAL_ERROR "LLVM Clang not found. Please install LLVM or set CMAKE_CXX_COMPILER manually.")
endif()
...
if(CLANG_VERSION_OUTPUT MATCHES "Apple clang")
    message(WARNING "Found Apple Clang instead of LLVM Clang: ${CLANG_VERSION_OUTPUT}")
