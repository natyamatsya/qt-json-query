# clang-cl Toolchain for Windows Configures CMake to use LLVM's clang-cl under
# MSVC-like environment
...
if(NOT CLANG_CL)
  message(
    FATAL_ERROR
      "clang-cl not found. Install LLVM or Visual Studio with LLVM/Clang tools and ensure clang-cl.exe is in PATH."
  )
endif()
...
# Use MSVC librarian (lib.exe) semantics with clang-cl. Do NOT override
# CMAKE_AR/CMAKE_RANLIB/CMAKE_NM to llvm-ar tools, because CMake will pass
# MSVC-style flags (/OUT, /nologo) for the librarian when using the MSVC-like
# clang-cl frontend. Overriding to llvm-ar causes flag mismatch.
