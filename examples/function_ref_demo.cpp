...
{
  public:
    void processResults(const std::vector<int>& results, stdcompat::function_ref<void(int)> callback)
    {
...
int main()
{
    ...
    processor.processResults(results, [](int value) { std::cout << "  Found result: " << value << std::endl; });
