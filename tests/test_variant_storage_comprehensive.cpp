...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        std::cout << "✓ Empty regular filter result: " << (emptyRegularResult ? "PASS" : "FAIL") << " (should be FAIL)\n";
        std::cout << "✓ Empty context filter result: " << (emptyContextResult ? "PASS" : "FAIL") << " (should be FAIL)\n";
