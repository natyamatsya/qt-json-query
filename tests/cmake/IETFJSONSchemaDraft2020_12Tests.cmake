...
set(IETF_JSON_SCHEMA_TEST_SUITE_DIR "${PROJECT_SOURCE_DIR}/compliance/ietf-json-schema-draft-2020-12")
...
function(add_ietf_json_schema_draft_2020_12_tests)
    ...
    if(EXISTS "${IETF_JSON_SCHEMA_TEST_SUITE_DIR}")
        ...
        target_compile_features(ietf_json_schema_draft_2020_12_compliance_tests PRIVATE cxx_std_23)

        # Test discovery
        gtest_discover_tests(ietf_json_schema_draft_2020_12_compliance_tests
            DISCOVERY_MODE PRE_TEST
            TEST_PREFIX "IETFJSONSchema/Draft2020-12/")

        message(STATUS "Added IETF JSON Schema Draft 2020-12 compliance tests target: ietf_json_schema_draft_2020_12_compliance_tests")
    else()
        message(STATUS "IETF JSON Schema Test Suite not found at ${IETF_JSON_SCHEMA_TEST_SUITE_DIR}")
        message(STATUS "To enable compliance tests, run:")
        message(STATUS "  git submodule add https://github.com/json-schema-org/JSON-Schema-Test-Suite.git compliance/ietf-json-schema-draft-2020-12")
