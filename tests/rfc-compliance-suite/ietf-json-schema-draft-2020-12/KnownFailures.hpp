...
// UTS #46 (ada backend) gaps vs IDNA 2008 ------------------------------------
// Active only when the IDN feature is built with the default ada backend:
// UTS #46 does not enforce the RFC 5892 CONTEXTO rules (MIDDLE DOT, KERAIA,
// GERESH/GERSHAYIM, KATAKANA MIDDLE DOT), the DISALLOWED exception set, or
// the Hangul tone-mark rejection, and it rejects one Punycode form libidn2
// accepts. Selecting the LGPL libidn2 backend resolves these.
inline constexpr KnownFailure kKnownFailuresIdnAda[] = {
    {"idn-hostname.json",
     "validation of internationalized host names",
    ...
    {"idn-hostname.json", "validation of internationalized host names", "Greek KERAIA not followed by Greek"},
    {"idn-hostname.json", "validation of internationalized host names", "Greek KERAIA not followed by anything"},
    {"idn-hostname.json", "validation of internationalized host names", "Hebrew GERESH not preceded by anything"},
    {"idn-hostname.json", "validation of internationalized host names", "Hebrew GERSHAYIM not preceded by anything"},
    {"idn-hostname.json",
     "validation of internationalized host names",
    ...
    {"idn-hostname.json", "validation of internationalized host names", "MIDDLE DOT with no following 'l'"},
    {"idn-hostname.json", "validation of internationalized host names", "MIDDLE DOT with no preceding 'l'"},
    {"idn-hostname.json", "validation of internationalized host names", "MIDDLE DOT with nothing following"},
    {"idn-hostname.json", "validation of internationalized host names", "MIDDLE DOT with nothing preceding"},
    {"idn-hostname.json",
     "validation of internationalized host names",
...
inline bool
matchesKnownFailure(const KnownFailure (&table)[N], const QString& file, const QString& group, const QString& test)
{
